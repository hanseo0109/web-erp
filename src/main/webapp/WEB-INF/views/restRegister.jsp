    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="${cpath}/register" method="post">
                ...
                <!-- 등록 버튼을 누르면 form action이 실행되는 것이 아닌 ->  server Controller에 -> POST : http://localhost:8081/weberp/api/books로 가서 -> json으로 값을 전달해야 함 -->
                <button type="submit" class="btn btn-primary" onclick="goRegister()">등록</button>
                <button type="reset" class="btn btn-primary">취소</button>
            </form>
        </div>
        <div class="card-footer">패스트캠퍼스 부트캠프 8기 한성민</div>
    </div>
</div>
